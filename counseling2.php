...
<head>
    ...
    <style>
        ...
        textarea:focus {
            border-color: #9C27B0; /* हलका बैंगनी */
            outline: none;
        }
        button {
            width: 100%;
        ...
        button:hover {
            background-color: #6A1B9A; /* हलका बैंगनी */
        }
        .response {
            margin-top: 20px;
            padding: 15px; /* बढ़ा हुआ पेडिंग */
            background-color: #e1bee7; /* हलका बैंगनी */
            border-radius: 5px;
            color: #333;
            font-size: 20px; /* बढ़ा हुआ फॉन्ट आकार */
            text-align: left;
...
<div class="counseling-box">
    <h1>काउंसलिंग कोना</h1>
    <p>मेरे साथ अपनी समस्या साझा करें:</p>
    ...
    function runModel($message) {
        $apiKey = '100b6eac43c1d209592993093a5f5c700aed182937e7e42243b6bb8752e8a98a'; // यहाँ अपनी API कुंजी डालें
        ...
        while (true) {
            sleep(5); // फिर से पोलिंग करने से पहले 5 सेकंड इंतजार करें
            ...
            if ($statusResult === FALSE) {
                $error = error_get_last();
                echo "<div class='response'>मॉडल स्थिति पोलिंग में त्रुटि: " . $error['message'] . "</div>";
                break;
            }
