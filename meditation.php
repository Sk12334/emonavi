...
<head>
    ...
    <title>Meditation Corner</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            background-color: #e1f5fe; /* Pastel sky blue */
            display: flex;
        ...
        textarea {
            ...
            border-radius: 5px;
            padding: 15px;
            border: 2px solid #fbc02d; /* Light yellow */
            margin-bottom: 20px;
            resize: none;
        ...
        textarea:focus {
            border-color: #c6a700; /* Darker yellow */
            outline: none;
        }
        button {
            width: 100%;
            padding: 15px;
            background-color: #fbc02d; /* Light yellow */
            color: white;
            border: none;
            border-radius: 5px;
            cursor: pointer;
        ...
        button:hover {
            background-color: #c6a700; /* Darker yellow */
        }
        .response {
            margin-top: 20px;
...
<div class="meditation-box">
    ...
    <p>Let's combine mindfulness with calming sounds:</p>
